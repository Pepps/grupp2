    ...
    <div class="col-sm-8 col-sm-offset-2">
        ...
        <form method="POST" action="/ducks" novalidate>
            <div class="form-group @if ($errors->has('name')) has-error @endif">
                ...
                <input type="text" id="name" class="form-control" name="name" placeholder="Somebody Important" value="{{ Input::old('name') }}">
            ...
            <div class="form-group @if ($errors->has('password_confirm')) has-error @endif">
                ...
                @if ($errors->has('password_confirm')) <p class="help-block">{{ $errors->first('password_confirm') }} @endif </p>
            </div>
